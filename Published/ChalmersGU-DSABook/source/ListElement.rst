.. raw:: html
   ...
   <script>ODSA.SETTINGS.MODULE_SECTIONS = ['homogeneity', 'element-deletion', 'practice-questions'];</script>
...
.. raw:: html
   ...
   <script>ODSA.SETTINGS.DISP_MOD_COMP = true;ODSA.SETTINGS.MODULE_NAME = "ListElement";ODSA.SETTINGS.MODULE_LONG_NAME = "List Element Implementations";ODSA.SETTINGS.MODULE_CHAPTER = "Linear Structures"; ODSA.SETTINGS.BUILD_DATE = "2021-09-24 12:54:10"; ODSA.SETTINGS.BUILD_CMAP = true;JSAV_OPTIONS['lang']='en';JSAV_EXERCISE_OPTIONS['code']='pseudo';</script>
