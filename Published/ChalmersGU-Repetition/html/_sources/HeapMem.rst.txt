.. raw:: html
   ...
   <script>ODSA.SETTINGS.MODULE_SECTIONS = ['allocation', 'deallocation', 'programming-the-heap', 'a-heap-example', 'arrays'];</script>
...
local stack memory.
:ref:`Local memory  <LocalMem>` is quite automatic.
