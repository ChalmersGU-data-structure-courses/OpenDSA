.. raw:: html
   ...
   <script>ODSA.SETTINGS.MODULE_SECTIONS = ['sharing', 'shallow-and-deep-copying', 'what-does-it-mean-to-copy', 'shallow-and-deep-comparing', 'bad-references', 'why-are-bad-reference-bugs-so-common'];</script>
