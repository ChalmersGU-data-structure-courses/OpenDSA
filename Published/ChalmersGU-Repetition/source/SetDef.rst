.. raw:: html
   ...
   <script>ODSA.SETTINGS.MODULE_SECTIONS = ['set-notation', 'relations', 'equivalence-relations', 'partial-orders'];</script>
...
The :term:`UNION/FIND  <UNION/FIND>` algorithm efficiently
maintains equivalence classes on a set.
One application for such :term:`disjoint sets` 
computing a :term:`minimal cost spanning tree  <MCST>`.
